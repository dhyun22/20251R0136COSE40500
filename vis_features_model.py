...
# Main execution loop
target_img_list = glob.glob(f"{args.image_path}/4849/model_0.jpg")
...
for idx, tgt_img in enumerate(target_img_list):
    ...
    src_img = f"{os.path.dirname(tgt_img)}/model_1.jpg"
    src_mask = f"{args.mask_path}/{img_id}/model_upper_mask_00.png"  
    tgt_mask = f"{args.mask_path}/{img_id}/model_upper_mask_01.png" 
    result = process_images(src_img, tgt_img, src_mask, tgt_mask)


target_img_list_2 = glob.glob(f"{args.image_path}/4849/model_1.jpg")
target_img_list_2 = sorted(target_img_list_2)

for idx, tgt_img in enumerate(target_img_list_2):
    img_id = os.path.basename(os.path.dirname(tgt_img))
        
    src_img = f"{os.path.dirname(tgt_img)}/model_2.jpg"
    src_mask = f"{args.mask_path}/{img_id}/model_upper_mask_02.png"  
    tgt_mask = f"{args.mask_path}/{img_id}/model_upper_mask_01.png" 
    result = process_images(src_img, tgt_img, src_mask, tgt_mask)


target_img_list_3 = glob.glob(f"{args.image_path}/4849/model_0.jpg")
target_img_list_3 = sorted(target_img_list_3)

for idx, tgt_img in enumerate(target_img_list_3):
    img_id = os.path.basename(os.path.dirname(tgt_img))
